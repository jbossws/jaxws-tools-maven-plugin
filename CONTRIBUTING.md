...
## Git Setup
To contribute, you first need to fork the [jaxws-tools-maven-plugin](https://github.com/jbossws/jaxws-tools-maven-plugin) repository.
...
```
To pull update from the jaxws-tools-maven-plugin upstream, the jaxws-tools-maven-plugin remote can be added to your local git repo :
```
git remote add upstream https://github.com/jbossws/jaxws-tools-maven-plugin.git
```
Before change/fix, always pull update from jaxws-tools-maven-plugin:
```
$ git checkout -f main
